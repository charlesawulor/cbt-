...
$end_time = $end_time = date('Y-m-d H:i:s', strtotime('+'.$_SESSION["duration"].'seconds', strtotime($_SESSION["start_time"])));
...
.city {display:none;}
	...
	function timeout(){
		var hours=Math.floor('<?php echo $duration ?>');
		//var minute=Math.floor(('<?php echo $duration ?>')/60);
